 ...
 *|companyurl|*
 *|department|*
 *|countryname|*							(Full Country Name)		(c) changed to the FullName
 ...
 *|webpage|*								(Users WWW webpage)		(www)
 ...
 Formatting Values:							(style = 'display:none') is set to display nothing if the corresponding variable (without _v) is blank
											This means that you can use a <Span> + another <Span> to hide or show text if a value is blank or is not.
 *|company_v|*
 *|companyphone_v|*
 *|companyfax_v|*
 *|companyurl_v|*
 ...
 *|extranote_v|* 
 *|notes_v|*  
 *|socialicons_v|* 									If the user has -social in their AD notes then this is set to display none
 ...
 ** The '>' character is not allowed in any value - as this character determines the end of the value to place into the variable.
 ...
 <*|Company|*Privium>								set the company value to Privium
 ...
 <*|ReplaceEmailDomain|*XXXX.XXX,xxxxx.xx>			Change Email Domain Name to the first 1 listed, if found in the subsequent ones
													EG: @privium.com.au,@impacthomes.com.au,@impact.com.au
 ...
 <*|MemberNote|*LDAP://CN=SG-OutlookSignatureNOTE1,OU=OutlookSignatureNotes,OU=Signatures,OU=Groups,OU=PVG,DC=ad,DC=priviumgroup,DC=com,DC=au>
													If the user is a member if this Group then the |extranote| = Group Description Text
